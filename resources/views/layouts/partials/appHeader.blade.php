             ...
             <div class="main-header-container container-fluid">
                     ...
                     <div class="header-element">
                         <div class="horizontal-logo">
                             <a href="{{ route('dashboard') }}" class="header-logo">
                                 <img src="{{ asset('assets') }}/images/myafia.png" alt="logo" class="desktop-logo">
                                 <img src="{{ asset('assets') }}/images/myafia.png" alt="logo" class="toggle-logo">
                                 <img src="{{ asset('assets') }}/images/myafia.png" alt="logo"
                                     class="desktop-white">
                                 <img src="{{ asset('assets') }}/images/myafia.png" alt="logo" class="toggle-white">
                             </a>
                         </div>
                     </div>
                     <!-- End::header-element -->
                 ...
                 <div class="header-content-right">
                     ...
                     <div class="header-element messages-dropdown">
                         ...
                         <!-- End::header-link|dropdown-toggle -->
                         @include('layouts.partials.headerMessage')
                     </div>
                     <!-- End::header-element -->
                     ...
                     <div class="header-element notifications-dropdown main-header-notification">
                         ...
                         <!-- End::header-link|dropdown-toggle -->
                         @include('layouts.partials.headerNotifications')
                     </div>
                     <!-- End::header-element -->
                     ...
                     <div class="header-element header-fullscreen">
                         ...
                         <a onclick="openFullscreen();" href="javascript:void(0);" class="header-link">
                             ...
                             <svg xmlns="http://www.w3.org/2000/svg"
                                 class="full-screen-close full-screen-icon header-link-icon d-none"
                                 fill="currentColor" height="24" viewBox="0 -960 960 960" width="24">
                                 <path
                     ...
                     <div class="header-element headerProfile-dropdown">
                         ...
                         <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                             ...
                             @if (Auth::user()->photo)
                                 <img src="data:image/jpg;base64,{{ Auth::user()->photo }}" alt="user_myafia_logo"
                                     class="rounded-circle header_avatar" width="37" height="37">
                             @else
                                 <img src="{{ asset('assets') }}/images/default_avatar.png" alt="user_myafia_logo"
                                     width="37" height="37" class="rounded-circle header_avatar">
                             @endif
                                 ...
                                 <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                                     <div class="my-auto">
                                         <h6 class="mb-0 lh-1 text-fixed-white">{{ Auth::user()->name }}</h6><span
                                             class="fs-11 op-7 lh-1">{{ Auth::user()->place }}</span>
                                     </div>
                                 </div>
                             </li>
                             ...
                             <li>
                                 <form action="{{ route('logout') }}" method="post">
                                     ...
                                     <button type="submit" class="dropdown-item d-flex">
                                         <i class="bx bx-log-out fs-18 me-2 op-7"></i>
                                         Sign Out
                                     </button>
                                 </form>
